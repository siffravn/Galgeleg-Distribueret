...
public interface Brugeradmin extends java.rmi.Remote {
	 ...
	 * @return et Bruger-objekt med alle data
	 */
	Bruger aendrAdgangskode(String brugernavn, String glAdgangskode, String nyAdgangskode) throws java.rmi.RemoteException;
	...
	void sendGlemtAdgangskodeEmail(String brugernavn, String folgetekst) throws java.rmi.RemoteException;
	 ...
	 * @throws java.rmi.RemoteException Hvis der sker en fejl i transport eller på serveren
	 */
	void setEkstraFelt(String brugernavn, String adgangskode, String feltnavn, Object vaerdi) throws java.rmi.RemoteException;
